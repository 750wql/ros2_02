...
bool info_interfaces__msg__point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("info_interfaces.msg._point.Point", full_classname_dest, 32) == 0);
  }
  info_interfaces__msg__Point * ros_message = _ros_message;
  {  // x
...
PyObject * info_interfaces__msg__point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("info_interfaces.msg._point");
