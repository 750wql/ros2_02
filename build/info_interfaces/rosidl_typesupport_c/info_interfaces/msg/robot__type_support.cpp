...
static const _Robot_type_support_symbol_names_t _Robot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, info_interfaces, msg, Robot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, info_interfaces, msg, Robot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, info_interfaces, msg, Robot)() {
  return &::info_interfaces::msg::rosidl_typesupport_c::Robot_message_type_support_handle;
}
