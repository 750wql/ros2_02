...
#include "info_interfaces/msg/detail/robot__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  info_interfaces::msg::Robot & ros_message)
{
  ...
  // Member: enemy
  {
    ...
    ros_message.enemy.resize(size);
    for (size_t i = 0; i < size; i++) {
      info_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.enemy[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: enemy
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        info_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.enemy[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = info_interfaces::msg::Robot;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const info_interfaces::msg::Robot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<info_interfaces::msg::Robot *>(
    untyped_ros_message);
...
{
  return &info_interfaces::msg::typesupport_fastrtps_cpp::_Robot__handle;
}
