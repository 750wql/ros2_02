...
#include "info_interfaces/msg/detail/map__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // mat
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // mat

// forward declare type support functions


using _Map__ros_msg_type = info_interfaces__msg__Map;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: mat
  {
    size_t size = ros_message->mat.size;
    auto array_ptr = ros_message->mat.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: mat
  {
    ...
    if (ros_message->mat.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->mat);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->mat, size)) {
      fprintf(stderr, "failed to create array for field 'mat'");
      return false;
    }
    auto array_ptr = ros_message->mat.data;
...
size_t get_serialized_size_info_interfaces__msg__Map(
  const void * untyped_ros_message,
...
static uint32_t _Map__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_info_interfaces__msg__Map(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_info_interfaces
size_t max_serialized_size_info_interfaces__msg__Map(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = info_interfaces__msg__Map;
    is_plain =
      (
...
static size_t _Map__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_info_interfaces__msg__Map(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, info_interfaces, msg, Map)() {
