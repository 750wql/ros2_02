...
#include "info_interfaces/msg/detail/robot__rosidl_typesupport_fastrtps_c.h"
...
#include "info_interfaces/msg/detail/point__functions.h"  // enemy, our_robot
...
using _Robot__ros_msg_type = info_interfaces__msg__Robot;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: enemy
  {
    ...
    auto array_ptr = ros_message->enemy.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: enemy
  {
    ...
    if (ros_message->enemy.data) {
      info_interfaces__msg__Point__Sequence__fini(&ros_message->enemy);
    }
    if (!info_interfaces__msg__Point__Sequence__init(&ros_message->enemy, size)) {
      fprintf(stderr, "failed to create array for field 'enemy'");
      return false;
    }
    auto array_ptr = ros_message->enemy.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_info_interfaces__msg__Robot(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Robot__ros_msg_type * ros_message = static_cast<const _Robot__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_info_interfaces__msg__Point(
    &(ros_message->our_robot), current_alignment);
  // field.name enemy
  {
    size_t array_size = ros_message->enemy.size;
    auto array_ptr = ros_message->enemy.data;
...
static uint32_t _Robot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_info_interfaces__msg__Robot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_info_interfaces
size_t max_serialized_size_info_interfaces__msg__Robot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = info_interfaces__msg__Robot;
    is_plain =
      (
...
static size_t _Robot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_info_interfaces__msg__Robot(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, info_interfaces, msg, Robot)() {
